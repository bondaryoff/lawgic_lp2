  ...
  <header class="header bdb">
    ...
    <div class="mobile-menu">
      <div class="mobile-menu-wr">
        ...
        <div class="menu__social-bar">

          <a style="display: flex;height: 45px;align-items: center; width: 290px;" href="" class="btn btn__gold" data-fancybox><span>Звернутись за допомогою</span></a>
    ...
    <div class="promo__row bdl bdr">
      <div class="promo__box">
          ...
          <div class="promo__grid">
            ...
            <div class="promo__form">
              <div class="promo__form--box">
                ...
                <?php echo do_shortcode('[contact-form-7 id="014a452" title="Мобілізація? Звільнення? відсрочка? Вирішимо законно та швидко"]'); ?>
              </div>
            </div>
          </div>
        ...
        <div class="promo__butom">
          ...
          <div class="promo__social-bar">
            <?php if (get_field('linkedin', 'option')) : ?>
              <a href="<?php the_field('linkedin', 'option'); ?>" target="_blank" rel="nofollow noopener">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-white-in.svg" width="20" height="19" alt="linkedin">
              </a>
            <?php endif; ?>
            <?php if (get_field('x', 'option')) : ?>
              <a href="<?php echo get_field('x', 'option'); ?>" target="_blank" rel="nofollow noopener">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-white-x.svg" width="17" height="18" alt="X">
              </a>
            <?php endif; ?>
            <?php if (get_field('instagram', 'option')) : ?>
              <a href="<?php echo get_field('instagram', 'option'); ?>" target="_blank" rel="nofollow noopener">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-white-insta.svg" width="20" height="19" width="20" height="20" alt="instagram">
              </a>
            <?php endif; ?>
            <?php if (get_field('faceboock', 'option')) : ?>
              <a href="<?php echo get_field('faceboock', 'option'); ?>" target="_blank" rel="nofollow noopener">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-white-fb.svg" width="12" height="20" alt="faceboock">
              </a>
            <?php endif; ?>
            <?php if (get_field('youtube', 'option')) : ?>
              <a href="<?php echo get_field('youtube', 'option'); ?>" target="_blank" rel="nofollow noopener">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-white-youtube.svg" width="20" height="15" alt="youtube">
              </a>
            <?php endif; ?>
          </div>
        </div>
