  <section class="military-law" id="military-law">
    <div class="container">
      <div class="bdl bdr">
        <div class="h2-title">
          <?php if (get_field('military_law_zagolovok')) : ?>
            <h2><?php echo get_field('military_law_zagolovok'); ?></h2>
          <?php endif; ?>
        </div>
      </div>
      <div class="military-law__slider">
        <div class="swiper-wrapper">
          <?php $military_law = get_field('military_law'); ?>
          <?php foreach ($military_law as $item) : ?>
            <div class="swiper-slide">
              <a href="#pop-up" data-source="<?php echo htmlspecialchars(strip_tags($item['nazva'])); ?>" class="military-law__item" data-fancybox>
                <div class="military-law__img">
                  <?php
                  $image_id = $item['zobrazhennya'];
                  get_picture($image_id, 'militarylaw', esc_html(get_the_title()))
                  ?>
                </div>
                <div class="military-law__text">
                  <?php echo $item['nazva']; ?>
                </div>
              </a>
            </div>
        ...
        <div class="military-law__prev"><svg width="22" height="105" viewBox="0 0 22 105" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <linearGradient id="paint0_linear_2060_3681" x1="-85.715" y1="111.315" x2="28.5247" y2="25.6238" gradientUnits="userSpaceOnUse">
                <stop offset="0.0580958" stop-color="#E6D1BE" />
                <stop offset="0.929784" stop-color="#896954" />
              </linearGradient>
            </defs>
          </svg>
        </div>
        <div class="military-law__next"><svg width="21" height="105" viewBox="0 0 21 105" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="military-law__slidewr">
        <div class="military-law__slide"></div>
      </div>
