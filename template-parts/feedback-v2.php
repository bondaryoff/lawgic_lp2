      ...
      <div class="feedback__grid">
        <div class="feedback__left bdr">
          ...
          <div class="feedback__body bdt bdb">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/feedback22.png" width="219.28" height="224.36" alt="feedback">
          </div>
          <?php
        ...
        <div class="feedback__right">
          ...
          <div class="feedback__body bdb bdt">
            <?php echo do_shortcode('[contact-form-7 id="96d74a3" title="edback-ua"]'); ?>
          </div>
          <div class="feedback__footer ">
          </div>
        </div>
